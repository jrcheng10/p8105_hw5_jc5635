...
For a series of true means (i.e. μ = {0,1,2,3,4,5,6}), we generate 5,000 observations per mean from the normal distribution, with n = 30 and σ = 5, and report the estimated mean and p-value from a t-test, with a null hypothesis of μ = 0 and α = 0.05.
